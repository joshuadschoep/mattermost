...
const MobileChannelHeader = makeAsyncComponent(
    "MobileChannelHeader",
    lazy(() => import("components/mobile_channel_header"))
);
...
export default class CenterChannel extends React.PureComponent<Props, State> {
    ...
    render() {
        const { lastChannelPath, isMobileView } = this.props;
        const isCollapsedThreadsEnabled = true;
